                            ...
                            <div class="art-post-body">
                                <div class="art-post-inner art-article">
                                    ...
                                    <div class="art-postcontent">
                                        <a href="<?=base_url('index.php/Anggota/add')?>" class="art-button">Tambah Anggota</a><br /><br />
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td><?=$no++?></td>
                                                <td><a href="<?=base_url('index.php/Anggota/detail/'.$member->get_id())?>" rel="facebox"><?=$member->get_name()?></td>
