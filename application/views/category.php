                            ...
                            <div class="art-post-body">
                                <div class="art-post-inner art-article">
                                    ...
                                    <div class="art-postcontent">
                                        <a href="<?=base_url('index.php/Property/add_category')?>" class="art-button">Add Category</a><br /><br />
                                        <!-- article-content -->
                                        <table>
                                            <tr>
                                                <th>No</th>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="art-button" href="<?=base_url('index.php/Property/edit_category/'.$category->get_id())?>">Edit</a></td>
                                                <?php } ?>
                                        </table>
