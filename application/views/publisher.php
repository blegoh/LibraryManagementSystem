                            ...
                            <div class="art-post-body">
                                <div class="art-post-inner art-article">
                                    ...
                                    <div class="art-postcontent">
                                        <a href="<?=base_url('index.php/Property/add_publisher')?>" class="art-button">Add Publisher</a><br /><br />
                                        <!-- article-content -->
                                        <table>
                                            <tr>
                                                <th>No</th>
                                            ...
                                            <tr>
                                                <td><?=$i++?></a></td>
                                                <td><?=$publisher->get_name()?></td>
                                                <td><a class="art-button" href="<?=base_url('index.php/Property/edit_publisher/'.$publisher->get_id())?>">Edit</a></td>
                                                <?php } ?>
                                        </table>
