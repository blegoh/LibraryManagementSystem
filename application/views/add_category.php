                                ...
                                <div class="art-post-inner art-article">
                                    ...
                                    <div class="art-postcontent">
                                        <div class="form">
                                            ...
                                            <form action="<?=base_url('index.php/Property/add_category/')?>" id="form-kategori" method="post">
                                                <label>Nama</label>
                                                <input type="text" name="nama" />
                                                <br />
                                                <label>&nbsp;</label><input type="submit" class="art-button" value="Save" />&nbsp;<input type="button" value="cancel" onclick="location.href='<?=base_url('index.php/Property/category/')?>';" class="art-button" />
                                            </form>
                                        </div>
